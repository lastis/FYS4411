...
ax.plot(bins1, densityMean1,'b',label='With Jastrow factor')
ax.fill_between(bins1, densityMean1-densityStd1, densityMean1+densityStd1, color='b', alpha=0.2)
ax.plot(bins2, densityMean2,'r',label='Without Jastrow factor')
...
plt.savefig('neon_03_pretty.png')
plt.show()
