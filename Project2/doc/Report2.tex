...
\eq{
  ...
  &=2\sum_{i=1}^{k-1}\frac{\partial^2 f_{ik}}{\partial x_k^2}\ +
    \left[\sum_{i=1}^{k-1}\frac{\partial f_{ik}}{\partial x_k} -
    \sum_{i=k+1}^{N}\frac{\partial f_{ki}}{\partial x_i}
    \right]^2\\
  &=2\sum_{i=1}^{k-1}\frac{\partial}{\partial x_k}\left(
    \frac{\partial f_{ik}}{\partial r_{ik}} \frac{\partial r_{ik}}{\partial x_k}\right) +
    \left[\sum_{i\neq k}\frac{\partial f_{ik}}{\partial r_{ik}}
    \right]^2\\
}
\section{Results}
