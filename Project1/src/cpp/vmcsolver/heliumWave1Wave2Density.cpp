...
int main()
{
    ...
    solver1.h2 = 1e+06;
    solver1.idum = 1;
    solver1.localEnergyFunction = solver1.LOCAL_ENERGY_HELIUM_1;

    solver1.setRecordPositions(true);
    ...
    solver2.setRecordPositions(true);

    // Data collection
    ofstream myFile;
    string base = "../../../res/";
    string directory = "heliumWave1Wave2Density/";
    string fName;
    string adress;
